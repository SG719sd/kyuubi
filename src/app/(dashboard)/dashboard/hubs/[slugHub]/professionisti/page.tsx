...
import ProfessionistiView from '@/components/views/dashboard/professionisti/professionisti-view';
  ...
  return (
    <HubPageWrapper slugHub={hubSlug}>
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-indigo-900 via-slate-900 to-indigo-950 text-white rounded-3xl p-6 md:p-8 shadow-xl border border-indigo-500/20">
        ...
        {/* Pulsante torna indietro integrato nella Hero */}
        <div className="mb-6">
          <BackButton />
        </div>
        ...
        <div className="relative z-10 space-y-3 max-w-3xl">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-500/20 border border-indigo-400/30 text-indigo-200 text-xs font-medium">
            <span>🛡️ Team & Permessi</span>
          </div>

          <h1 className="text-2xl md:text-4xl font-extrabold tracking-tight text-white">
            Professionisti dell'Hub
          </h1>

          <p className="text-xs md:text-sm text-indigo-100/80 leading-relaxed">
            Gestisci e organizza i collaboratori del tuo Hub, assegna i ruoli, imposta i permessi e personalizza le loro schede identificative.
          </p>
        </div>

        {/* Effetti grafici di sfondo */}
      ...
      {/* Vista Gestionale (Lista, Filtri e Drawer) */}
      <ProfessionistiView
